...
export default function Footer() {
  return (
    <div className="flex flex-col px-16 py-8 gap-10 border-t">
      <div className="w-full  grid grid-cols-2 ">
        ...
        <div className="w-full">
          ...
          <div className="flex gap-5 font-semibold ">
            <div className="bg-gray-400 w-64 ">
              ...
              <span className="px-2 py-5">BLOG</span>
            </div>
            <div className="bg-gray-400 w-64 ">
            ...
            <div className="bg-gray-400 w-64 ">
              ...
              <span className="px-2 ">GYMSHARK TRAINING</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t flex  items-center justify-between text-gray-600 font-semibold text-xl px-5 py-5 ">
        ...
        <div className="flex gap-10 border-l px-2 items-center justify-center">
